...
public class APIActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    public final static String EXTRA_MESSAGE = "com.example.weathersnap.MESSAGE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mForecastAdapter = new ArrayAdapter<String>(this, R.layout.activity_api,
                R.id.currentWeatherTextView, weekForecast);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] result) {
            if (result != null) {
                ...
                TextView currentWeather = (TextView) findViewById(R.id.currentWeatherTextView);
                currentWeather.setText("Ruh roh!");
            }
        }
    }
}